...
{
    [Fact]
    public void GetPacketType_DataIsNull_ThrowsArgumentNullException()
    {
        // Arrange.
        var service = new PacketService();

        // Act. / Assert.
        Assert.Throws<ArgumentNullException>(() => service.GetPacketType(null!));
    }

    [Fact]
    public void GetPacketType_DataLengthIsTooLow_ThrowsPacketException()
    {
        // Arrange.
        ...
        // Act. / Assert.
        Assert.Throws<PacketException>(() => service.GetPacketType(arr));
    }
    ...
    public void GetPacketType(byte lsb, byte msb, ZToolCmdType expectedCmdType)
    {
        // Arrange.
        ...
        // Act.
        var result = service.GetPacketType(arr);
