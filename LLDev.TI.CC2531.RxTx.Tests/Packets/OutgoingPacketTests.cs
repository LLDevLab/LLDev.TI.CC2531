...
public class OutgoingPacketTests
{
    ...
    [Theory]
    [MemberData(nameof(BuildPacketTestMethodInput))]
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "xUnit1042:The member referenced by the MemberData attribute returns untyped data rows", Justification = "Cannot use MemberData with internal types")]
    internal void BuildPacket(OutgoingPacket request, byte[] manualResult)
    {
        // Act.
